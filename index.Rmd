...
In this paper, we introduce the I'-chart, outline its theoretical foundation and evaluate its performance using a range of healthcare and synthetic data sets. Our paper is guided by the following practical questions:
...
To demonstrate the application of I'-charts on count data we used data on bacteremia cases and mortality. Data sets are tabulated in [Appendix 1](#app1).
