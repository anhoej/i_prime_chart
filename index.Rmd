...
The I'-chart has superior design properties to the traditional I-chart and merits broader use and evaluation. The use of the traditional I-chart for data with varying denominators is increasingly difficult to justify.
...
Data are included in Appendix 1.
...
a. For count data, the I'-chart closely approximates the behaviour of Laney’s prime charts (P'-chart and U'-charts).  Also, the I' chart can be used to normalize non-count data, like averages, where P'- and U'-charts do not apply. For averages, the I' chart accounts for both between and within subgroup variation, which can cause false positives on an X-bar chart.
...
A single chart, the I'-chart, can replace the myriad of SPC charts (Xbar-, C-, U-, P-, U'-, and P'-charts), as it gives consistent results.
