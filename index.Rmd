...
### Measurement data with denominator

...

### Count and measurement data without denominator
...
* The I prime chart plots the ratios of numerator / denominator. If measurement data have been aggregated in advance and we want to plot the numerators rather than the ratios, we must multiply the numerator and the denominator before plotting.
